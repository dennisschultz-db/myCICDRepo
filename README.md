# taxi_processing_bundle

The 'taxi_processing_bundle' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] taxi_processing_job` to your workspace.
